...
module.exports = {
  ...
  head: {
    ...
    },
    {
      rel: 'stylesheet',
      type: 'text/css',
      href: '/css/fonts/style.css'
    },
    {
      rel: 'stylesheet',
      type: 'text/css',
      href: 'https://cdn.bootcss.com/highlight.js/9.18.1/styles/a11y-light.min.css'
    }
    ],
    script: [{
  ...
  plugins: [
    ...
    // $axios拦截
    {
      src: '@plugins/client/axios',
      mode: 'client'
    },
    // 移动端自动缩放
    {
      src: '@plugins/client/viewport',
      mode: 'client'
    },
    // 移动端eruda调试
    {
      src: '@plugins/client/mb-test',
      mode: 'client'
    },
    // 打印
    {
      src: '@plugins/client/say',
      mode: 'client'
    }
  ],
  /**
