    ...
    >
      <div class="wd-window-form">
        <form>
          ...
          <!-- 媒体的简介 -->
          <div v-if="level===3" class="wd-form-unit-h">
            <label class="required" for="cover">简介</label>
            <input type="text" id="cover" v-model="entity.introduce" />
          </div>
          <!-- 媒体的简介 -->
          <div v-if="level===3" class="wd-form-unit-h">
            <label class="required" for="url">链接</label>
            <input type="text" id="url" v-model="entity.url" />
          </div>
          <!-- 媒体类型列表 -->
          <div v-if="level===3" class="wd-form-unit-h">
            <label class="required" for="url">类型</label>
            <SelectComponent v-model="entity.type" :list="typeList" />
          </div>
          <!-- 是否可见 -->
          <div class="wd-form-unit-h">
