...
@Component({layout:'admin',components:{ButtonComponent,TableComponent,SelectComponent}})
export default class TopicClassifyComponent extends BaseComponent {
     ...
     */
    selectClassifyList() {
        this.httpRequest(this.http.get('/topicClass/select/list?type='+this.searchModule),{
            success: (data: any) => {
    ...
    delete() {
        ...
        this.httpRequest(this.http.post('/topicClass/batch/delete',this.ids),{
            success: (data: any) => {
                this.handler.toast({
                    text:data.tip
                });
    ...
    insertOrUpdate() {
        ...
        this.httpRequest(this.http.post('/topicClass/batch/insertOrUpdate',this.rows),{
            success: (data: any) => {
