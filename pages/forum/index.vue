<!--
 * @Author: your name
 * @Date: 2019-12-15 22:41:15
 * @LastEditTime: 2020-03-20 20:30:31
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \nuxt-ssr\pages\forum\index.vue
 -->
/* * Filename: d:\frontend\vue\nuxt-ssr\pages\forum\forum.vue * Path:
d:\frontend\vue\nuxt-ssr * Created Date: Saturday, December 7th 2019, 1:21:16 pm
* Author: zzp-dog * 论坛首页 * Copyright (c) 2019 Your Company */

<template>
  <div id="id-ui-forum">
    <!-- 论坛页内容头部开始 -->
    <div class="ui-forum-header">
      <!-- 头部左侧banner开始 -->
      <div class="ui-forum-cover">
        <img src="@/assets/images/carousel-test/tantailang.jpg" alt />
      </div>
      <!-- 头部左侧banner结束 -->

      <!-- 右侧推荐面板开始 -->
      <div class="ui-forum-recommend">
        <!-- 推荐标题开始 -->
