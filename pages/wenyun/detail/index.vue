/* * Filename: d:\frontend\vue\nuxt-ssr\pages\wenyun\detail\_id.vue * Path:
d:\frontend\vue\nuxt-ssr * Created Date: Saturday, December 7th 2019, 8:24:08 pm
* Author: zzp-dog * 问题详情 * Copyright (c) 2019 Your Company */
<template>
  <div id="id-ui-wenyun-detail">
    <div class="wd-stairs-content">
      <!-- 问题作者信息 -->
    <div class="wd-content-head">
      <div class="wd-content-head-left" @mouseenter="showMask(block)" @mouseleave="hideMask(block)">
        <img :src="block.cover" alt="模块封面" />
        <template v-if="block.mask">
          <div class="wd-content-head-cover-mask"></div>
          <div class="wd-content-concern" @click="collect(block)">
            <template v-if="getConcern(block) === 1">
        ...
        <div class="wd-stair2-level0-head ui-first-stair">
          ...
          <div class="wd-stair2-level1-head-info">
            <p>
              ...
              <!-- vip或svip，额外标识 -->
              <span v-if="vip.identity" class="wd-user-vip">
                {{
                vip.identity
                }}
              </span>
      ...
      <div class="wd-stair2-level1" v-for="(item, index) in topReplys" :key="index">
        ...
        <div class="wd-stair2-level1-body" :ref="'reply' + index">
          ...
          <div class="wd-stair-level1-content-wrap">
            <!-- 1级回复内容 -->
            <p class="wd-stair2-right-wrap-body-level-1" v-html="item.text"></p>
            <!-- 1级回复信息条 -->
          ...
          <div class="wd-stair2-level2" v-for="(item_, index_) in item.comments" :key="index_">
            ...
            <div class="wd-stair2-level2-head">
              ...
              <div>
                <p>
                  <!-- 1级回复 - 第几层 -->
                  <span class="wd-stair2-level2-index">#{{
                    index +
                    2 +
                    "-" +
            ...
            <div class="wd-stair2-level2-body">
              ...
              <div class="wd-stair-level2-content-wrap">
                <!-- 2级回复内容 -->
                <p class="wd-stair2-level2-content" v-html="item_.text"></p>
                <!-- 2级回复信息条 -->
